# -*- coding: utf-8 -*-
"""
Created on Mon May  1 15:58:17 2023
...
def add_dots(lon, lat,diff,vmin,vmax):    
    ...
    plt.savefig('C:/Users/fanwang/Desktop/spatial_trend_ea_summer_new.eps',bbox_inches = 'tight')
    plt.show()

ll_sel = np.loadtxt(r'D:/paper_moisture/Data/ll_sel2.txt')
stations = ll_sel[:,0]
year_ave=np.loadtxt('D:/paper_moisture/Data/water_vapor_all.txt')
...
diff = mois
add_dots(ll_sel[index_p[0],5],ll_sel[index_p[0],4],diff[index_p[0]]*10,-0.5,0.5)
